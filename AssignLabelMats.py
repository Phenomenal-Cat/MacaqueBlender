...
HeadObj         = bpy.data.objects["MacaqueHeadNG_1expressions1"]
NonFaceObjs     = [["CorneaL", "CorneaR"], ["TeethUp","TeethDown","Tongue_1"], ["BodyZremesh2"]]
NonFaceNames    = ["Eyes","InnerMouth","Body"]
NonFaceIndx     = [0,8,5]

MatNames        = ["Head","Ears","InnerEye","OuterEye","Nose","OuterMouth"]
VertGrpNames    = [["cou"],["oreillefur"],["24846", "6523"],["5405"], ["32211"], ["42027"]]                           
GrpIndx         = [3, 4, 1, 2, 6, 7]

AllMats         = [mat for mat in bpy.data.materials if mat.name.startswith("Label_")]                      # Check whether label materials exist
FurGroups       = [["poilbase","sourcils"], ["oreille"], ["cils"],[],[],["poilbouche", "MOUSTACHES"]]
FurGrpIndx      = [[3,3], [4], [1], [], [], [7,7]]
ParticleIndx    = [[1, 3], [5], [4], [], [], [6,0]]
