...
for n in range(0, len(ParamsFiles)):
    ...
    IsCoo   = f.find("Coo")>0                           # Is the main facial expression a 'coo' face?
    LoadOrigMovie   = 1                                 # Render original movie to a plane in the scene?
    ...
    BoneWeight      = [0.007,       0.04,       0.02,   0.04,       0.02,       0.02,       0.02,       1]                  # Maximum values for each bone position
