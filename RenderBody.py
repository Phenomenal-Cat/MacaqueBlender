...
RenderDir   = '/Volumes/projects/murphya/AdaptationExp/BodySet/'
...
for az in Azimuths:
    bpy.data.objects['Body'].rotation_euler = mu.Vector((math.radians(90), 0, math.radians(az)))
    lon = 1;
    for lon in Lamps:
        for loff in Lamps:
        ...
        RenderFilename = "BodyAdapt_Az%d_El0_Lamp%d.png" % (az, lon)
