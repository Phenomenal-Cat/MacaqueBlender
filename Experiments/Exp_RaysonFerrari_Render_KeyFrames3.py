...
def GetAllParamsFiles():
    ...
    RootDir     = '/Volumes/Kastner/aidan/MacaqueExpressions/'
    DataDir     = RootDir + 'ExtractedParams/Selected/'
    OutputDir   = RootDir + 'RenderedFrames/' 
    MovieDir    = RootDir + 'OriginalMovies/'

    #ParamsFiles = ['Chewing_MT_S03E01_1638_1.csv','AM_Stumpy_Neutral_V2.csv','Spice_Threat_01_v2.csv','AM_20180930_Vivy_FearGrimace_1_v3.csv','BeckRaw_02-01-02-LipsmackV3_2sec.csv']
    ParamsFiles = ['Exp2_Threat_Spice_01_v2.csv']#'Exp2_Lipsmack_BeckRaw_02-01-02-V3_2sec.csv']# 'Exp2_Fear_AM_20180930_Vivy_1_v3.csv']#, , 'Exp2_Threat_Spice_01_v2.csv']    
    DataFile = []
