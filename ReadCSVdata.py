...
#DataFile    = 'ST_Coo_MovS26'
DataFile    = 'BE_Scream_mov59'
...
MovieFile   = Prefix + 'murphya/MacaqueFace3D/Macaque_video/Originals/' + DataFile + '.mpg'
...
#============== Set parameters
BoneNames       = ['blink', 'Kiss', 'jaw', 'ears', 'Fear', 'yawn', 'eyebrow']
BoneVectorIndx  = [2, 1, 2, 1, 1, 2, 2]
BoneDirection   = [1, 1, 1, -1, -1, 1, -1]
BoneWeight      = [0.007, 0.02, 0.02, 0.04, 0.02, 0.02, 0.02] 
BoneOffset      = [0, 0, 0, 0.02, 0, 0, 0]
...
LoadOrigMovie   = 0                                                 # Render original movie to plane in scene?
...
for haz in HeadAzimuths:
    for hel in HeadElevations:
        ...
        for n in AllData:
            ...
            exp = 0
            for e in BoneNames:                                                                                                         # For each bone...
            ...
            Filename = "%s_animation_Haz%d_Hel%d_%d.png" % (DataFile[0:len(DataFile)-4], haz, hel, frame)
